...
import islandScene from "../assets/3d/station.glb";
...
const { actions } = useAnimations(animations, islandRef);
  ...
  useFrame(() => {
    setRot.current =  islandRef.current.rotation.y;
    ...
    if (!isRotating) {
      ...
      if (Math.abs(rotationSpeed.current) < 0.0004) {
      ...
      <a.group name="Scene">
        ...
        <a.group name="Star" scale={1.141}>
          ...
          <mesh
            ...
            material={materials["Star Emmisive"]}
          />
        </a.group>
        <a.group name="Sector" position={[0, 0.14, 0]}>
          <mesh
            name="Cube"
            castShadow
            receiveShadow
          ...
          <mesh
            ...
            material={materials["Orange Emmision"]}
          />
          <mesh
            name="Cube_2"
            castShadow
